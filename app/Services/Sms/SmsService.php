...
class SmsService
{
     ...
     */
    public static function sendConfirm($phone, $job = null, $provider = 'auto'): mixed
    {
        ...
        //        if ($provider == "telegram" or $provider == "auto") {
     ...
     * @throws IsBlockException
     */
    public static function checkConfirm(string|int $phone, int $code): bool
    {
        $smsConfirm = SmsConfirm::query()->where(['phone' => $phone])->first();
