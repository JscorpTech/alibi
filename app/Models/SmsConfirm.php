...
class SmsConfirm extends Model
{
    ...
    public const RESEND_BLOCK_MINUTES = 10;
    public const TRY_BLOCK_MINUTES = 2;
    public const RESEND_COUNT = 5;
    public const TRY_COUNT = 10;
    ...
    public function syncLimits(): void
    {
    ...
    public function interval($time): \DateInterval
    {
