    ...
    <div class="d-flex align-items-center">
        ...
        <a class="navbar-brand" href="{{route("dashboard")}}">
            <div class="d-flex align-items-center py-3">
                ...
                <span
                    class="font-sans-serif text-primary">{{Env::get("APP_NAME")}}</span></div>
        </a>
    </div>
        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                @foreach($menus as $key=>$menu)
                    <li class="nav-item">
                        <a class="nav-link @if($route_name == $key) active @endif()"
                           href="{{$menu['route']}}">
                            <div class="d-flex align-items-center"><i class="far {{$menu['icon']}}"></i><span
                ...
                @foreach($dropdowns as $dropdown)
                    <li class="nav-item">
                        <a class="nav-link dropdown-indicator" href="#drop-item-{{$dropdown['name']}}" role="button"
                           data-bs-toggle="collapse"
                           aria-expanded="true" aria-controls="dashboard">
                            <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                                <span class="fas {{$dropdown['icon'] ?? "fa-edit"}}"></span>
                            </span>
                                <span class="nav-link-text ps-1">{{__($dropdown['name'])}}</span>
                            </div>
                        </a>
                        {{--@if($route[0] == $dropdown['name']) show @endif()--}}
                        <ul class="nav collapse show"
                            id="drop-item-{{$dropdown['name']}}">
                            @foreach($dropdown['items'] as $key=>$value)
                                <li class="nav-item"><a
                                        class="nav-link @if($route[1] == $key and $route[0] == $dropdown['name']) active @endif()"
                                        href="{{$value}}">
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">{{__($dropdown['name'].".".$key)}}</span>
                                        </div>
                                    </a>
                                </li>
                            @endforeach
                ...
                <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0"
                    ...
                    <div class="bg-white dark__bg-1000 rounded-3 py-2"><a
                            ...
                            href="../documentation/customization/styling.html">Styling<span
                                class="badge rounded-pill ms-2 badge-subtle-success">{{__("update")}}</span></a><a
                            class="dropdown-item link-600 fw-medium"
