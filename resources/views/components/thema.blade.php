        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2"
                ...
                <div class="flex-1">
                    ...
                    <p class="fs-10 mb-0">Switch your language direction </p><a class="fs-10" href="#">RTL
                        Documentation</a>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2" src="{{asset("assets/img/icons/arrows-h.svg")}}"
                ...
                <div class="flex-1">
                    ...
                    <p class="fs-10 mb-0">Toggle container layout system </p><a class="fs-10" href="#">Fluid
                        Documentation</a>
                </div>
            </div>
