...
<x-layouts.main>
    <form action="{{route("category.store")}}" class="needs-validation" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card mb-3">
            <div class="card-body">
                <div class="row flex-between-center">
                    ...
                    <div class="col-auto">
                        <a href="{{route("category.index")}}" class="btn btn-link text-secondary p-0 me-3 fw-medium"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div class="row gx-2">
                                <div class="col-12 mb-3">
                                    ...
                                    <input min="1" required value="{{old("position",1)}}"
                                ...
                                <div class="col-12">
                                    <label class="form-label"
                                           for="product-subcategory">{{__("product.select-gender")}}
                                                    ...
                                                    class="form-select {{Helper::isError($errors,"gender")}}"
                            ...
                            <div class="row gx-2">
                                <div class="col-12">
                                    ...
                                    <input min="1" required value="{{old("image",1)}}"
