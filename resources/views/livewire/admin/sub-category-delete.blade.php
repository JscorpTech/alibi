<div
    :class="deleteModal.open ? 'visible' : ''"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" x-on:click="deleteModal.open = false"
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <div class="flex justify-between">
                    <button x-on:click="$wire.delete(deleteModal.id)" data-modal-hide="popup-modal" type="submit"
                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                        {{__("yes")}}
                    </button>
                    <button x-on:click="deleteModal.open=false" type="button"
